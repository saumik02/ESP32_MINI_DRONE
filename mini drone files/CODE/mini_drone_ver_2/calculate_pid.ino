...
void calculate_pid(void) {
  ...
  pid_yaw_setpoint = pid_yaw_setpoint/3;
...
void reset_pid(void) {
  pid_i_mem_roll = 0; pid_last_roll_d_error = 0; pid_output_roll = 0;
  pid_i_mem_pitch = 0; pid_last_pitch_d_error = 0; pid_output_pitch = 0;
  pid_i_mem_yaw = 0; pid_last_yaw_d_error = 0; pid_output_yaw = 0;
}
